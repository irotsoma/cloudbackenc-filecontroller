...
/**
 * Used to interpret rest exceptions and return the friendly error message as a header. Also avoids JSON parsing exceptions by the rest template by removing the body.
 */
@ControllerAdvice
